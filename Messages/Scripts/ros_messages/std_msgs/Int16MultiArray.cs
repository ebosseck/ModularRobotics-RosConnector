...
{
    public class Int16MultiArrayMsg : ROSMessage
    {
        ...
        public static void _registerMessage () {
            ...
            {
                return new Int16MultiArrayMsg(msg);
            });
        }
        ...
        public Int16MultiArrayMsg(MultiArrayLayoutMsg layout = null, List<short> data = null) : base()
        {
            this.layout = layout;
            this.data = data;
        }

        public Int16MultiArrayMsg(Message message) : base()
        {
