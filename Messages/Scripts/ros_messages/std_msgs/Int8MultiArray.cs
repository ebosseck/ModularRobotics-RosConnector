...
{
    public class Int8MultiArrayMsg : ROSMessage
    {
        ...
        public static void _registerMessage () {
            ...
            {
                return new Int8MultiArrayMsg(msg);
            });
        }
        ...
        public Int8MultiArrayMsg(MultiArrayLayoutMsg layout = null, List<sbyte> data = null) : base()
        {
            this.layout = layout;
            this.data = data;
        }

        public Int8MultiArrayMsg(Message message) : base()
        {
