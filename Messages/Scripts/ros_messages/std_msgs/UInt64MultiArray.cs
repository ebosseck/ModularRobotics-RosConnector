...
{
    public class UInt64MultiArrayMsg : ROSMessage
    {
        ...
        public static void _registerMessage () {
            ...
            {
                return new UInt64MultiArrayMsg(msg);
            });
        }
        ...
        public UInt64MultiArrayMsg(MultiArrayLayoutMsg layout = null, List<ulong> data = null) : base()
        {
            this.layout = layout;
            this.data = data;
        }

        public UInt64MultiArrayMsg(Message message) : base()
        {
