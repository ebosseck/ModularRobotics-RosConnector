...
{
    public class UInt32MultiArrayMsg : ROSMessage
    {
        ...
        public static void _registerMessage () {
            ...
            {
                return new UInt32MultiArrayMsg(msg);
            });
        }
        ...
        public const string _ROS_MESSAGE_ID = "std_msgs/UInt32MultiArray";

        public UInt32MultiArrayMsg(MultiArrayLayoutMsg layout = null, List<uint> data = null) : base()
        {
            this.layout = layout;
            this.data = data;
        }

        public UInt32MultiArrayMsg(Message message) : base()
        {
        ...
        public override void serializeToMessage(Message message, bool includeHeader = true)
        {
            ...
            message.AddUInts(this.data.ToArray());
        }
        ...
        public override void deserializeFromMessage(Message message)
        {
            ...
            this.data = new List<uint>(message.GetUInts());
        }
