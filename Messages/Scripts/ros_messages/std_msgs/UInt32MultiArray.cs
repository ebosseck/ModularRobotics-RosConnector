...
{
    public class UInt32MultiArrayMessage : ROSMessage
    {
        ...
        public static void _registerMessage () {
            ...
            {
                return new UInt32MultiArrayMessage(msg);
            });
        }
        ...
        public UInt32MultiArrayMessage(MultiArrayLayoutMessage layout = null, List<uint> data = null) : base()
        {
            this.layout = layout;
            this.data = data;
        }

        public UInt32MultiArrayMessage(Message message) : base()
        {
