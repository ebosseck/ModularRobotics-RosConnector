...
{
    public class WrenchStampedMsg : ROSMessage
    {
        ...
        public static void _registerMessage () {
            ...
            {
                return new WrenchStampedMsg(msg);
            });
        }
        ...
        public const string _ROS_MESSAGE_ID = "geometry_msgs/WrenchStamped";

        public WrenchStampedMsg(HeaderMsg header = null, WrenchMsg wrench = null) : base()
        {
            this.header = header;
            this.wrench = wrench;
        }

        public WrenchStampedMsg(Message message) : base()
        {
        ...
        public override void serializeToMessage(Message message, bool includeHeader = true)
        {
            ...
            this.wrench.serializeToMessage(message, includeHeader: false);
        }
        ...
        public override void deserializeFromMessage(Message message)
        {
            ...
            this.wrench.deserializeFromMessage(message);
        }
